...
<html lang="en">
  ...
  <head>
    ...
    <title>Geber.id - Gerak Bersama Indonesia</title>
        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <a href="index.html" class="logo">
              <img src="{{ asset('logo.png') }}" height="40" alt="Chain App Dev">
            </a>
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
              ...
              @auth
              <li><div class="gradient-button"><a id="modal_trigger" href="{{ route('dashboard') }}"><i class="fa fa-sign-in-alt"></i> Dashboard</a></div></li>
              @else
              <li><div class="gradient-button"><a id="modal_trigger" href="{{ route('login') }}"><i class="fa fa-sign-in-alt"></i> Masuk / Daftar</a></div></li>
              @endauth
            </ul>
